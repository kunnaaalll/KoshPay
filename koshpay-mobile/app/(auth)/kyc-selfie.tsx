...
export default function KYCSelfieScreen() {
  ...
  const handleContinue = async () => {
    if (!photo) {
      Alert.alert("No Photo", "Please capture your Selfie photo");
      return;
    }
    try {
      ...
      formData.append("kycSelfieImage", {
        uri: photo,
        name: "selfie-image.jpg",
        type: "image/jpeg",
      } as any);
      ...
      if (!res.ok) {
        alert(data.error || "Failed to save Selfie photo, Please Try Again :(");
        return;
      }
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: theme.text }]}>Upload Selfie</Text>
